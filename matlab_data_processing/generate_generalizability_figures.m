...
% %     saveas(gcf, strcat("generalizability_", MAX_Vs(v_iter), ".jpg"))
%     ax = gca;
%     % Requires R2020a or later
%     exportgraphics(ax, strcat("generalizability_", MAX_Vs(v_iter), ".jpg"),'Resolution',300) 
    
end

% bar_data = [hausdorff_default' hausdorff_learned'];
% figure()
% set(gcf, 'WindowState', 'maximized');
% bar(bar_data)
% mean(bar_data, 1)